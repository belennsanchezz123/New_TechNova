...
try {
    db.exec(`
        CREATE TABLE IF NOT EXISTS participant_metrics (
            ...
            s1_mfa_started                  INTEGER,
            s1_mfa_completed                INTEGER,
            s1_mfa_step_reached             INTEGER,
            s1_mfa_method_primary           TEXT,
            s1_mfa_method_backup            TEXT,
            s1_mfa_abandon_reason           TEXT,
            s1_mfa_time_spent_sec           INTEGER,
            ...
            s3_sensitive_data_sent_to_llm   INTEGER,
            s3_llm_policy_complied          INTEGER,
            s3_secure_data_transmission     TEXT,
            s3_ai_prompt_text               TEXT,
