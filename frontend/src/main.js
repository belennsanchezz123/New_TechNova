...
import { openEmail, openComposeEmail, handlePhishingClick, reportEmail, useAI, sendDocument, addAttachment, selectAttachment, closeAttachmentModal, sendComposedEmail, cancelCompose } from './handlers/scenario3.js';
