...
export const emails = [
    ...
    {
      id: 5,
      from: 'RRHH TechNova Pagos',
      fromEmail: 'no-reply@technova-rrhh-pagos.info',
      subject: '⚠️ URGENTE: Bono de 1.200€ bloqueado — acción requerida HOY',
    body: 'Estimado/a Empleado/a,<br><br>Le informamos que su <b>Bono de Bienvenida por valor de 1.200,00 €</b> ha sido BLOQUEADO por el departamento de pagos debido a datos bancarios incorrectos o ausentes en su perfil.<br><br>⚠️ Si no completa el formulario de verificación <b>antes de las 14:00h de hoy</b>, el importe será reasignado automáticamente y <u>no podrá reclamarlo</u>.<br><br>Complete sus datos ahora:<br><br><span onclick="window.handlePhishingClick(true, 5)" data-preview-url="http://technova-rrhh-pagos.info/verificacion-bono?ref=EMP2026&token=8f3kzp" title="http://technova-rrhh-pagos.info/verificacion-bono?ref=EMP2026&token=8f3kzp" style="color: #0078d4; font-weight: bold; cursor: pointer; text-decoration: underline;">🔗 VERIFICAR DATOS BANCARIOS</span><br><br><small style="color:#888;">Este mensaje ha sido generado automáticamente. No responda a este correo. Departamento de Nóminas y Compensación — TechNova Group S.L.</small>',
      read: false,
    reportedAsPhishing: false,
      type: 'phishing-creds',
      time: '8:01 AM'
    ...
    {
      id: 7,
            from: 'Great Place To Work [EXTERNO]',
            fromEmail: 'survey@gptw-employee-feedback.com',
            subject: 'TechNova ha sido nominada — completa la encuesta anónima',
        body: 'Hola,<br><br>Tu empresa <b>TechNova</b> ha sido nominada al certificado <b>Great Place To Work 2026</b>. Tu opinión es clave para obtener la certificación.<br><br>La encuesta es completamente anónima y solo tarda 2 minutos. Los resultados se presentarán al comité directivo.<br><br><span onclick="window.handlePhishingClick(true, 7)" data-preview-url="http://gptw-employee-feedback.com/survey?org=technova&token=emp2026" title="http://gptw-employee-feedback.com/survey?org=technova&token=emp2026" style="color: #0078d4; font-weight: bold; cursor: pointer; text-decoration: underline;">📋 COMPLETAR ENCUESTA ANÓNIMA</span><br><br><small style="color:#888;">Este enlace es personal e intransferible. Encuesta disponible hasta el 30 de abril de 2026.</small>',
      read: false,
    reportedAsPhishing: false,
      type: 'phishing-creds',
      time: '7:40 AM'
